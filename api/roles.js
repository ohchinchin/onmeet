const ROLES_MASTER = [
    ...
    { id: "13", role: "教育学者", "name": "サクラ", "personality": "次世代への影響を第一に考える。熱意がある。" },
    ...
    { id: "29", role: "伝統工芸士", "name": "源さん", "personality": "経験と直感を重んじる。言葉に重みがある。" },
];
const MODERATOR_ROLE = { id: "30", role: "司会者", name: "レイコ", personality: "中立的。議論を整理し、総括を行う。" };
